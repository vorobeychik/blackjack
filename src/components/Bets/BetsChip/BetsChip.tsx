...
export function BetsChip({mainColor,secondaryColor,number,numberColor}:BetsChipProps){
    ...
    <svg width="82" height="83" viewBox="0 0 82 83" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <line y1="40" x2="80" y2="40" stroke={secondaryColor} stroke-width="4"/>
        <line x1="42" y1="2" x2="42" y2="82" stroke={secondaryColor} stroke-width="4"/>
        ...
        {/*<path   style={{textAlign:'center'}}d={path} fill={numberColor}/>*/}
        {/*<path style={{textAlign:'center'}}d={boldPath} fill={numberColor}/>*/}
